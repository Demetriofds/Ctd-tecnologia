			...
			<div class="about">
				<div class="container">
					...
					<section class="caixas-blog letra-blog">
						<div>
							<p>Planejamento de Recursos da Empresa, sim esta é uma tradução importante este software que foi desenvolvido com o objetivo de não apenas facilitar, mas organizar totalmente o fluxo de informações de uma empresa.</p>
						</div>
						<div>
